...
for i, (filename, (x, y, w, h)) in enumerate(zip(os.listdir(test_folder), xy)):
    if filename.endswith(".png"):
        ...
        cv2.putText(output, label_text, (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0),thickness=1)
        cv2.putText(output, accuracy_text, (x, y - 15), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0),thickness=1)
